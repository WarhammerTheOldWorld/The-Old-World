...
#define ui_sstore1 "NORTH7,7"
#define ui_id "NORTH7,7"
#define ui_belt "SOUTH-2,5.25"
#define ui_back "EAST-8.5,SOUTH-2"
#define ui_rhand "SOUTH-0.5,7"
#define ui_lhand "SOUTH-0.5,9"
#define ui_swaphand2 "8:16,2:5"
#define ui_storage1 "SOUTH-0.5,6"
#define ui_storage2 "SOUTH-0.5,10"
...
#define ui_swaphand1 "SOUTH-1.25,8"
#define ui_dropbutton "SOUTH-2,9.5"
#define ui_drop_throw "SOUTH-2,9.5"
#define ui_pull "SOUTH-2,11.5"
#define ui_jmp_kck "SOUTH-2, 13"
#define ui_atk "SOUTH-2, 14"//atk_intents
#define ui_resist "EAST+1, NORTH-14"
#define ui_acti "SOUTH-1,11"
#define ui_combat "SOUTH-2,8"//COMBAT MODE!
#define ui_combat_intent "SOUTH-2,10.5"
#define ui_movi "EAST,SOUTH-2"
#define ui_zonesel "SOUTH+1, WEST"
#define ui_acti_alt "SOUTH-1,11" //alternative intent switcher for when the interface is hidden (F12)
...
#define ui_kick_jump "EAST+1, NORTH-14"
...
#define ui_fixeye "EAST+1, NORTH-11" // "EAST+1, NORTH-6"
...
#define ui_happiness "SOUTH, WEST"
#define ui_nutrition "EAST+1, NORTH-10"
#define ui_internal "NORTH7,7"
									//borgs
...
//Pop-up inventory
#define ui_shoes "SOUTH-2,2"

#define ui_iclothing "SOUTH-2,3"
#define ui_oclothing "SOUTH-1,3"
#define ui_gloves "SOUTH-2,4"

#define ui_glasses "NORTH7,7"
#define ui_mask "SOUTH-1,2"
#define ui_l_ear "NORTH7,7"
#define ui_r_ear "NORTH7,7"
#define ui_neck "SOUTH-1,4"

#define ui_head "SOUTH,3"

//Attack intent
#define ui_att_int "SOUTH-1,11"
